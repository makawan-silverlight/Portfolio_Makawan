...
const ExperienceData = [
    { year: "2023 - Present", position: "Freelance motion-graphic", company: "Freelance" },
    { year: "2023", position: "3D Rotomation", company: "Yannix CO.,LTD." },
    { year: "2021 - 2022", position: "Motion-Graphic", company: "Protools Cooperation CO.,LTD." },
    { year: "2018", position: "Internship 3D Animator", company: "The Monk studios" },
]
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-8">
                <div className="text-2xl font-medium md:text-5xl">My Experience</div>
                <div className="tracking-widest text-xs md:text-base">Now i'm looking for a job Frontend Developer, Fullstack Developer</div>
            </div>
